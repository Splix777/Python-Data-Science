...
class Character(ABC):
    ...
    def __init__(self, first_first_first_name, is_alive=True):
        """Constructor for the Abstract Character class"""
        self.first_first_first_name = first_first_first_name
...
class Stark(Character):
    ...
    def __init__(self, first_first_first_name, is_alive=True):
        ...
        super().__init__(first_first_first_name, is_alive)
